    ...
    <div class="col-lg-8">
      ...
      {!! Form::open(['action' => 'CheckoutController@checkoutPaymentStore','method' => 'POST', 'class' => 'interactive-credit-card', 'id' => 'checkoutPayment']) !!}
        ...
        <div class="checkout-footer margin-top-1x">
          <div class="column">
            <a class="btn btn-outline-secondary" href="/checkout"><i class="icon-arrow-left"></i> Profile</a>
          </div>
          <div class="column">
            {!! Form::button('Complete Order <i class="icon-arrow-right"></i></a>', ['type' => 'submit', 'class' => 'btn btn-primary']) !!}
          </div>
        </div>
