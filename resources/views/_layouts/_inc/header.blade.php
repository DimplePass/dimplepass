      ...
      <nav class="site-menu">
        <ul>
          ...
          <li class="has-megamenu"><a href="#"><span>Destinations</span></a>
            <ul class="mega-menu">
              <li><span class="mega-menu-title">National Parks</span>
                <ul class="sub-menu">
              ...
              <li><span class="mega-menu-title">Ski/Summer Resorts</span>
                <ul class="sub-menu">
              ...
              <li>
                <section class="promo-box" style="background-image: url(img/destinations/yellowstone-300x300.jpg);"><span class="overlay-dark" style="opacity: .4;"></span>
                  <div class="promo-box-content text-center padding-top-2x padding-bottom-2x">
                    ...
                    <a class="btn btn-sm btn-primary" href="#">View Pass</a>
                  </div>
                </section>
              </li>
              <li>
          ...
          <li><a href="account-orders.html"><span>How it works?</span></a></li>
