    ...
    <div class="offcanvas-container" id="shop-categories">
      @if (Auth::user())
        <a class="account-link" href="/member/{{(empty(\Auth::user())) ?: \Auth::user()->id}}">
          <div class="user-ava">
      ...
      <div class="toolbar">
        <div class="inner">
          <div class="tools">
            ...
            <div class="account"><a href="/member/{{(empty(\Auth::user())) ?: \Auth::user()->id}}"></a><i class="icon-head"></i>
              <ul class="toolbar-dropdown">
                @if (Auth::user())
                  ...
                  <li><a href="/member/{{(empty(\Auth::user())) ?: \Auth::user()->id}}">My Passes <span class="badge badge-primary badge-pill">2</span></a></li>
                  <li><a href="/member/{{(empty(\Auth::user())) ?: \Auth::user()->id}}/edit">My Profile</a></li>
