...
@section('meta-page')
  <title>Dimple Pass - Vendor Terms & Conditions</title>
...
@section('meta-og')
  ...
  <meta property="og:title" content="Dimple Pass - Vendor Terms & Conditions"/>
...
<div class="container padding-bottom-2x mb-2">
  <div class="row">
    ...
    <div class="col-md-8 text-md-left text-center">
      ...
      <hr>
      <h3 class="mb-30">Reporting <small>Yearly Dimple visitor counts.</small></h3>
