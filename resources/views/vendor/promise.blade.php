...
@section('meta-page')
  <title>Dimple Pass - The Vendor Promise</title>
...
@section('meta-og')
  ...
  <meta property="og:title" content="Dimple Pass - The Vendor Promise"/>
    ...
    <div class="row">
      <div class="col-md-10 col-lg-8 padding-bottom-2x text-md-left text-center hero-overlay">
        <div class="hero-text">
          ...
          <h2 class="mt-0 mb-2 white-color"><strong>Your commitment to the Dimple Pass traveler.</strong></h2>               
        </div>
    </div>
  </div>
</section>
