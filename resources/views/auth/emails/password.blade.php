                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: 'Maven Pro', Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            <div style="line-height: 35px">
                                Password <span style="color: #009696;">Reset</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center">
                            <table align="center" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <a style="font-size: 14px; font-family: 'Maven Pro', sans-serif; line-height: 24px;color: #5caad2; text-decoration: none;font-weight:bold;" href="#">UNSUBSCRIBE</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
