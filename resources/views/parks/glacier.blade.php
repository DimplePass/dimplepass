    ...
    <div class="col-xl-9 col-lg-8 order-lg-2">
      ...
      <div class="product-card product-list">
        <a class="product-thumb" href="#">
          ...
          <img src="/img/vendors/ynp/sample-450x290.jpg" alt="Glacier Discounts">
        </a>
      ...
      <aside class="sidebar">
        ...
        <section class="widget">
          ...
          <div class="custom-control custom-checkbox">
            ...
            <label class="custom-control-label" for="cdy">Columbia Falls, MT <span class="text-muted">(3)</span></label>
          </div>
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="bsk">
            <label class="custom-control-label" for="bsk">East Glacier, MT <span class="text-muted">(2)</span></label>
          </div>
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="jkh">
            <label class="custom-control-label" for="jkh">St. Mary, MT <span class="text-muted">(5)</span></label>
          </div>
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="wys">
            <label class="custom-control-label" for="wys">West Glacier, MT <span class="text-muted">(3)</span></label>
          </div>
          <div class="custom-control custom-checkbox">
            <input class="custom-control-input" type="checkbox" id="grd">
            <label class="custom-control-label" for="grd">Whitefish, MT<span class="text-muted">(2)</span></label>
          </div>
        </section>
        <!-- Widget Type Filter-->
        <section class="widget">
