...
<section class="widget hidden-sm-down" id="filters">
  ...
  <div class="custom-control custom-checkbox">
    <input class="custom-control-input" type="checkbox" id="city2" value="city2">
    <label class="custom-control-label" for="city2">City, ST <span class="text-muted">(2)</span></label>
  </div>
  <div class="custom-control custom-checkbox">
    <input class="custom-control-input" type="checkbox" id="city3" value="city3">
    <label class="custom-control-label" for="city3">City, ST <span class="text-muted">(5)</span></label>
  </div>
  <div class="custom-control custom-checkbox">
    <input class="custom-control-input" type="checkbox" id="city4" value="city4">
    <label class="custom-control-label" for="city4">City, ST <span class="text-muted">(3)</span></label>
  </div>
  <div class="custom-control custom-checkbox">
    <input class="custom-control-input" type="checkbox" id="city5" value="city5">
